...
export default function LoginPage() {
  ...
  const [isLayoutReordered, setIsLayoutReordered] = useState(false);
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">註冊</h2>
        ...
        {/* Bottom Cards - Horizontal Layout - Show when layout is NOT reordered */}
        {!isLayoutReordered && (
